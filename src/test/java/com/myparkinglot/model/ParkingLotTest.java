...
import com.myparkinglot.exception.SlotAlreadyOccupiedException;
...
public class ParkingLotTest {
  ...
  public void testParkingCar() {
    final Car testCar = new Car("test-car-no");
  ...
  public void testParkingOnAlreadyOccupiedSlot() {
    final Car testCar1 = new Car("test-car-no1");
    final Car testCar2 = new Car("test-car-no2");
    final ParkingLot parkingLot = new ParkingLot(100);
